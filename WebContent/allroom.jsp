	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12">
				...
				<%
					db.close();
								response.setHeader("refresh", "1.5;URL=allroom.jsp");
							} else {
				%>
				<table class="table">
					<thead>
					...
					<tbody>
						...
						<tr>
							...
							<td><a
								href="changeroom.jsp?roomid=<%=list.get(i).getroomNum()%>">修改</a>
								<a href="delete.jsp?roomid=<%=list.get(i).getroomNum()%>">删除</a>
							</td>
						</tr>
						<%
							count++;
				...
				<div class="pagination pagination-centered pagination-small">
					<ul>
						<li><a href="allroom.jsp?curpage=1">首页</a></li>
						<li><a href="allroom.jsp?curpage=<%=curpage - 1%>">上一页</a></li>
						<li><a href="allroom.jsp?curpage=<%=curpage + 1%>">下一页</a></li>
						<li><a href="allroom.jsp?curpage=<%=pagecount%>">尾页 </a></li>
