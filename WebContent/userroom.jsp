			...
			<div class="span12">
				...
				<%
					database db = new database();
						...
						if (list.isEmpty()) {
				%>
				<span class="changfont">这位用户没有订单!</span>
				<%
					db.close();
				...
				<%
					db.close();
								...
								response.setHeader("refresh", "1.5;URL=userroom.jsp");
							} else {
				%>
				<table class="table">
					<thead>
				...
				<div class="pagination pagination-centered pagination-small">
					<ul>
						<li><a href="userroom.jsp?curpage=1&name=<%=user%>">首页</a></li>
						<li><a
							href="userroom.jsp?curpage=<%=curpage - 1%>&name=<%=user%>">上一页</a></li>
						<li><a
							href="userroom.jsp?curpage=<%=curpage + 1%>&name=<%=user%>">下一页</a></li>
						<li><a
							href="userroom.jsp?curpage=<%=pagecount%>&name=<%=user%>">尾页
						</a></li>
