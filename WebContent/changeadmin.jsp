...
<body>
	<%
		...
		if (!flag.equals("2")) {
			...
			String position = request.getParameter("adminposition");
	%>
					...
					<div class="row-fluid">
						<div class="span12">
							<div class="row-fluid">
								<div class="span4"></div>
								<div class="span4">
									<form class="form-inline" action="updateadmininfo.jsp">
										<fieldset>
											<label>管理员姓名</label><input type="text" value=<%=adminid%>
												disabled /> <br /> <br /> <label>管理员电话</label> <input
												type="text" value=<%=phone%> name="superphone" /><br /> <br />
											<label>管理员职务</label><select id="select1" name="select1">
												...
												name="superpasswd" value=<%=adminpasswd%> /><br /> <br />
											<div>
												...
												<div style="float: left; margin-left: 113px">
													<button type="reset" class="btn"
														onclick="javascript:window.location.href='alladmin.jsp">取消</button>
												</div>
											</div>
										</fieldset>
									</form>
