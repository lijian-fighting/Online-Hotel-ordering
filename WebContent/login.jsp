			...
			<div class="span12">
				...
				<div class="row-fluid">
					...
					<div class="span6" style="background: #eee;height: 450px">
						<form class="form-inline" action="enter.jsp"
							style="margin-top: 120px; margin-left: 70px">
							<fieldset>
								<div style="margin-left: 110px;">
								<span style="font-size:20px;">用户登录</span>
								</div>
								<br />
								<label>用户姓名</label><input type="text" name="user" /> <br />
								<br /> <br />
								<label>用户密码</label><input type="password" name="passwd" /> <br />
								<br />
								<div>
									...
									<div style="float: left; margin-left: 168px">
										<button type="button" class="btn"
											onclick="javascript:window.location.href='Newregister.jsp'">注册</button>
									</div>
								</div>
							</fieldset>
						</form>
