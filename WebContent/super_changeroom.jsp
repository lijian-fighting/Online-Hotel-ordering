					...
					<div class="row-fluid">
						<div class="span12">
							<div class="row-fluid">
								<div class="span4"></div>
								<div class="span4">
									<form class="form-inline" action="super_updating.jsp">
										<fieldset>
											<label>房间编号</label><input type="text" name="roomid"
												value=<%=roomid%> disabled /> <br />
											...
											<div>
												...
												<div style="float: left; margin-left: 113px">
													<button type="button" class="btn"
														onclick="javascript:window.location.href='super_allroom.jsp">取消</button>
												</div>
											</div>
										</fieldset>
									</form>
