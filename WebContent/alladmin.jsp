			...
			<div class="span12">
				...
				<%
					database db = new database();
						...
						if (list.isEmpty()) {
				%>
				<span class="changfont">没有管理员!</span>
				<%
					db.close();
				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<%
									out.print(list.get(i).getadminpasswd());
								%>
							</td>
							<td><a
								href="changeadmin.jsp?adminid=<%=list.get(i).getadminid()%>&adminpasswd=<%=list.get(i).getadminpasswd()%>&adminphone=<%=list.get(i).getphone()%>&adminposition=<%=list.get(i).getposition()%>">修改</a>
								<a href="deleteadmin.jsp?adminid=<%=list.get(i).getadminid()%>">删除</a>
							</td>
						</tr>
						<%
							count++;
				...
				<div class="pagination pagination-centered pagination-small">
					<ul>
						<li><a href="alladmin.jsp?curpage=1">首页</a></li>
						<li><a href="alladmin.jsp?curpage=<%=curpage - 1%>">上一页</a></li>
						<li><a href="alladmin.jsp?curpage=<%=curpage + 1%>">下一页</a></li>
						<li><a href="alladmin.jsp?curpage=<%=pagecount%>">尾页 </a></li>
