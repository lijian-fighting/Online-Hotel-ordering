					...
					<div class="row-fluid">
						<div class="span12">
							<div class="row-fluid">
								<div class="span4"></div>
								<div class="span4">
									<form class="form-inline" action="Newaddorder.jsp">
										<fieldset>
											<label>房间类型</label> <select id="select1" name="select1">
											...
											</select> <br /> <br /> <label>房间价格</label> <select id="select2"
												name="select2">
											...
											</select> <br /> <br /> <label>入住时间</label><input type="text"
												onclick="laydate()" name="entertime" /> <br /> <br /> <label>退房时间</label><input
												type="text" id="demo" name="lasttime" /> <br />
											<br />
											<div>
